    ...
    public partial class FrmMenü : Form
    {
        ...
        private void ShowDashbord()
        {
            try
            {
                ...
                FrmDashboard frmDashboard = new FrmDashboard(_user, _accounts) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
        ...
        private void btnNewAcc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.pnlFormload.Controls.Clear();
                FrmAddAcc frmAddAcc = new FrmAddAcc(_user, _accounts) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
        ...
        private void btnSettings_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.pnlFormload.Controls.Clear();
                FrmSettings frmSettings = new FrmSettings(_user, _accounts) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
